  ...
  const contactLinks = [
    {
      icon: Mail,
      label: 'Email',
      value: 'prasad.narkhede@tejgroup.in',
      href: 'mailto:prasad.narkhede@tejgroup.in',
      color: 'text-red-600',
      bgColor: 'bg-red-50'
    },
    {
      ...
      href: 'https://linkedin.com/in/prasadnarkhede',
      color: 'text-blue-600',
      bgColor: 'bg-blue-50'
    },
    {
      ...
      href: 'https://github.com/prasadnarkhede',
      color: 'text-gray-800',
      bgColor: 'bg-gray-50'
    },
    {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <p className="text-gray-600 mb-8 leading-relaxed">
              ...
              about cloud infrastructure and DevOps best practices.
            </p>
